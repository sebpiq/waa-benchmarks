var WasmDspModule = function(WasmDspModule) {
  WasmDspModule = WasmDspModule || {};
  var Module = WasmDspModule;
...
var Module;
if (!Module) Module = (typeof WasmDspModule !== 'undefined' ? WasmDspModule : null) || {};
...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'wasm_dsp_module.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'wasm_dsp_module.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'wasm_dsp_module.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wasm_dsp_module.js.mem" : null;




var STATIC_BUMP = 3072;
...
var _sum_osc_static = Module["_sum_osc_static"] = asm["_sum_osc_static"];
